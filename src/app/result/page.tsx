      ...
      <div className="w-[100%] md:w-[600px] bg-[#fff] flex flex-col items-center">
        ...
        <div>
          ...
          bg-[#E30211]"
            ...
            <button
              className={`w-[311px] h-[48px] mt-[24px] mb-[16px] flex items-center justify-center gap-[8px] rounded-[25px] text-[16px] font-[700] text-[#FF7CFF] transition-all duration-300
          `}
            >
